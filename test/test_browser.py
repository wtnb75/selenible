...
class TestBrowser(unittest.TestCase):
    ...
    def test_screenshot(self):
        _, drv = self.dummy()
        with (
            tempfile.NamedTemporaryFile(suffix=".png") as tf,
            tempfile.NamedTemporaryFile(suffix=".tar") as tfa,
        ):
    ...
    def test_settextvalue(self):
        ...
        exs.assert_called_once_with(
            "arguments[0].value = arguments[1];", elem, "hello world"
        )
